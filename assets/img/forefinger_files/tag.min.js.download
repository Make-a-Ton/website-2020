...
aiptag.settings = {
	...
	sPubName: 'SKR',
	sPubUrl: 'skribbl.io',
	sAdUnitVideo: 'SKR_skribbl.io_preroll-H',
...
function aipAPI() {
	...
	this.debug = this.validateQueryParams('aip_debug');
	this.aipAds = null;
	this.started = false;
	...
	if(aiptag.settings.iVideoAdUnitBidders) {
		this.videoAdUnit = [];
		this.videoAdUnit["SKR_skribbl.io_preroll-H"] = {
code: 'prerollUnit',
mediaTypes: {
	video: {
		context: 'instream',
...
aipAPI.prototype.cutomSizeConfig = function() {
		aipAPItag.log("cutomSizeConfig set");
}



var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.arrayIteratorImpl=function(a){var c=0;return function(){return c<a.length?{done:!1,value:a[c++]}:{done:!0}}};$jscomp.arrayIterator=function(a){return{next:$jscomp.arrayIteratorImpl(a)}};$jscomp.makeIterator=function(a){var c="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];return c?c.call(a):$jscomp.arrayIterator(a)};
aiptag.settings.iAmazonAds&&!function(a,c,b,d,e,f,n){c[a]||(c[a]={init:function(){c[a]._Q.push(["i",arguments])},fetchBids:function(){c[a]._Q.push(["f",arguments])},setDisplayBids:function(){},targetingKeys:function(){return[]},_Q:[]},f=b.createElement(d),f.async=!0,f.src=e,n=b.getElementsByTagName(d)[0],n.parentNode.insertBefore(f,n))}("apstag",window,document,"script","//c.amazon-adsystem.com/aax2/apstag.js");
aipAPI.prototype.detectBlockedAds=function(){(function(){var a=document.createElement("script");a.async=!0;a.onerror=function(){aipAPItag.gptBlocked=!0};a.type="text/javascript";a.src=aipAPItag.protocol+"api.adinplay.com/libs/aiptag/assets/adsbygoogle.js";var c=document.getElementsByTagName("script")[0];c.parentNode.insertBefore(a,c)})()};
aipAPI.prototype.initGPT=function(){if(aiptag.settings.iDFPAdSlots||aiptag.settings.sRewardedAdUnitVideo)googletag.cmd.push(function(){googletag.pubads().disableInitialLoad()}),aipAPItag.gptLoaded||(function(){var a=document.createElement("script");a.async=!0;a.type="text/javascript";a.src="https://securepubads.g.doubleclick.net/tag/js/gpt.js";var c=document.getElementsByTagName("script")[0];c.parentNode.insertBefore(a,c)}(),aipAPItag.gptLoaded=!0)};
function cmp_getlang(a){"boolean"!=typeof a&&(a=!0);if(a&&"string"==typeof cmp_getlang.usedlang&&""!==cmp_getlang.usedlang)return cmp_getlang.usedlang;a="DE EN FR IT NO DA FI ES PT RO BG ET EL GA HR LV LT MT NL PL SV SK SL CS HU RU SR ZH TR UK".split(" ");var c=[],b=location.hash,d=location.search,e="languages"in navigator?navigator.languages:[];if(-1!=b.indexOf("cmplang="))c.push(b.substr(b.indexOf("cmplang=")+8,2));else if(-1!=d.indexOf("cmplang="))c.push(d.substr(d.indexOf("cmplang=")+8,2));else if("cmp_setlang"in
window&&""!=window.cmp_setlang)c.push(window.cmp_setlang.toUpperCase());else if(0<e.length)for(b=0;b<e.length;b++)c.push(e[b]);"language"in navigator&&c.push(navigator.language);"userLanguage"in navigator&&c.push(navigator.userLanguage);e="";for(b=0;b<c.length;b++)if(d=c[b].toUpperCase(),-1!=d.indexOf("-")&&(d=d.substr(0,2)),-1!=a.indexOf(d)){e=d;break}if(""==e&&"string"==typeof cmp_getlang.defaultlang&&""!==cmp_getlang.defaultlang)return cmp_getlang.defaultlang;""==e&&(e="EN");return e=e.toUpperCase()}
aipAPI.prototype.initGDPR=function(){function a(e,f,n,l,g){"undefined"===typeof g&&(g="/");"undefined"===typeof l?(l=(window&&window.location&&window.location.hostname||"").split("."),l=";domain="+(1<l.length?l.slice(-2).join("."):"")):l="";var m=new Date;m.setSeconds(m.getSeconds()+n);document.cookie=e+" = "+f+l+";path="+g+";max-age="+n+";Expires="+m.toUTCString()}function c(){aipAPItag.start();try{var e=new CustomEvent("aip_consentnotrequired");document.dispatchEvent(e)}catch(f){}}function b(){aip_pbjs.setConfig({consentManagement:{gdpr:{cmpApi:"iab",
timeout:8E3,allowAuctionWithoutConsent:!0}}});var e=document.createElement("link");e.type="text/css";e.rel="stylesheet";e.href="https://cdn.consentmanager.mgr.consensu.org/delivery/cmp.min.css";document.getElementsByTagName("head")[0].appendChild(e);window.cmp_id="bottom"===aiptag.cmp.position?15920:13566;window.gdprAppliesGlobally=!1;window.cmp_target="_blank";window.cmp_stayiniframe=1;window.cmp_host="consentmanager.mgr.consensu.org";window.cmp_cdn="cdn.consentmanager.mgr.consensu.org";(function(){var f=
"",n="_en";"cmp_getlang"in window&&(f=window.cmp_getlang().toLowerCase(),n="_"+f);var l=document.createElement("script");l.src="https://"+window.cmp_host+"/delivery/cmp.php?id="+window.cmp_id+"&h="+encodeURIComponent(location.href)+"&"+window.cmp_params+(0<document.cookie.length?"&__cmpfcc=1":"")+"&l="+f+"&o="+(new Date).getTime();l.type="text/javascript";l.setAttribute("data-cmp-ab",1);l.async=!0;document.body?document.body.appendChild(l):document.currentScript?document.currentScript.parentElement.appendChild(l):
document.write(l.outerHTML);l=document.createElement("script");l.src="https://"+window.cmp_cdn+"/delivery/cmp"+n+".min.js";l.type="text/javascript";l.setAttribute("data-cmp-ab",1);l.async=!0;document.body?document.body.appendChild(l):document.currentScript?document.currentScript.parentElement.appendChild(l):document.write(l.outerHTML);window.cmp_addFrame=function(g){if(!window.frames[g])if(document.body){var m=document.createElement("iframe");m.style.cssText="display:none";m.name=g;document.body.appendChild(m)}else window.setTimeout('window.cmp_addFrame("'+
g+'")',10)};window.cmp_rc=function(g){for(var m=document.cookie,q="",t=0;""!=m&&100>t;){for(t++;" "==m.substr(0,1);)m=m.substr(1,m.length);var v=m.substring(0,m.indexOf("=")),x=-1!=m.indexOf(";")?m.substring(m.indexOf("=")+1,m.indexOf(";")):m.substr(m.indexOf("=")+1,m.length);g==v&&(q=x);v=m.indexOf(";")+1;0==v&&(v=m.length);m=m.substring(v,m.length)}return q};window.cmp_stub=function(){var g=arguments;__cmapi.a=__cmapi.a||[];if(g.length)if("ping"===g[0])if(2===g[1])g[2]({gdprApplies:gdprAppliesGlobally,
cmpLoaded:!1,cmpStatus:"stub",displayStatus:"hidden",apiVersion:"2.0",cmpId:31},!0);else g[2]({gdprAppliesGlobally:gdprAppliesGlobally,cmpLoaded:!1},!0);else if("getUSPData"===g[0])g[2]({version:1,uspString:window.cmp_rc("")},!0);else if("getTCData"===g[0])__cmapi.a.push([].slice.apply(g));else if("addEventListener"===g[0])__cmapi.a.push([].slice.apply(g));else if(4==g.length&&!1===g[3])g[2]({},!1);else __cmapi.a.push([].slice.apply(g));else return __cmapi.a};window.cmp_msghandler=function(g){var m=
"string"===typeof g.data;try{var q=m?JSON.parse(g.data):g.data}catch(v){q=null}if("object"===typeof q&&null!==q&&"__cmpCall"in q){var t=q.__cmpCall;window.__cmp(t.command,t.parameter,function(v,x){var w={__cmpReturn:{returnValue:v,success:x,callId:t.callId}};g.source.postMessage(m?JSON.stringify(w):w,"*")})}"object"===typeof q&&null!==q&&"__cmapiCall"in q&&(t=q.__cmapiCall,window.__cmapi(t.command,t.parameter,function(v,x){var w={__cmapiReturn:{returnValue:v,success:x,callId:t.callId}};g.source.postMessage(m?
JSON.stringify(w):w,"*")}));"object"===typeof q&&null!==q&&"__uspapiCall"in q&&(t=q.__uspapiCall,window.__uspapi(t.command,t.version,function(v,x){var w={__uspapiReturn:{returnValue:v,success:x,callId:t.callId}};g.source.postMessage(m?JSON.stringify(w):w,"*")}));"object"===typeof q&&null!==q&&"__tcfapiCall"in q&&(t=q.__tcfapiCall,window.__tcfapi(t.command,t.version,function(v,x){var w={__tcfapiReturn:{returnValue:v,success:x,callId:t.callId}};g.source.postMessage(m?JSON.stringify(w):w,"*")},t.parameter))};
window.cmp_setStub=function(g){g in window&&("function"===typeof window[g]||"object"===typeof window[g]||"undefined"!==typeof window[g]&&null===window[g])||(window[g]=window.cmp_stub,window[g].msgHandler=window.cmp_msghandler,window.addEventListener?window.addEventListener("message",window.cmp_msghandler,!1):window.attachEvent("onmessage",window.cmp_msghandler))};window.cmp_addFrame("__cmapiLocator");window.cmp_addFrame("__cmpLocator");window.cmp_addFrame("__uspapiLocator");window.cmp_addFrame("__tcfapiLocator");
window.cmp_setStub("__cmapi");window.cmp_setStub("__cmp");window.cmp_setStub("__tcfapi");window.cmp_setStub("__uspapi")})();__cmp("addEventListener",["consent",function(f,n){aipAPItag.log("AIP Ads started after consent");aipAPItag.start();var l="Privacy settings";aiptag.cmp.buttonText&&(l=aiptag.cmp.buttonText);var g="none";!0===aiptag.cmp.button&&(g="block");var m="bottom: 0px;left: 0px;border-top-left-radius: 3px;border-top-right-radius: 3px;";"bottom-right"==aiptag.cmp.buttonPosition&&(m="bottom: 0px;right: 0px;border-top-left-radius: 3px;border-top-right-radius: 3px;");
"top-right"==aiptag.cmp.buttonPosition&&(m="top: 0px;right: 0px;border-bottom-left-radius: 3px;border-bottom-right-radius: 3px;");"top-left"==aiptag.cmp.buttonPosition&&(m="top: 0px;left: 0px;border-bottom-left-radius: 3px;border-bottom-right-radius: 3px;");try{if(!aipAPItag.isInPage(document.getElementById("cmpPersistentLink"))){var q=document.createElement("div");document.getElementsByTagName("body")[0].appendChild(q);q.id="cmpPersistentLink";q.style.display=g;q.innerHTML='<a href="#" onclick="aipAPItag.showCMPScreen();return false;" class="cmp-persistent-link" style="text-decoration: none;cursor: pointer; position: fixed; background-color: #1f83be; padding: 5px 15px; color: #ffffff; display: flex; max-height: 30px; z-index: 999994;'+
...
l+"</a>"}}catch(D){}try{var t=new CustomEvent("aip_consent",{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(t);var v=n.getCMPData();if("vendorConsents"in v)if("755"in v.vendorConsents&&v.vendorConsents["755"])try{var x=new CustomEvent("aip_consentapproved",{detail:{eventname:void 0,cmpobject:void 0}});document.dispatchEvent(x)}catch(D){}else try{var w=new CustomEvent("aip_consentrejected",{detail:{eventname:void 0,cmpobject:void 0}});document.dispatchEvent(w)}catch(D){}}catch(D){}},!1],
null);__cmp("addEventListener",["init",function(f,n){try{var l=new CustomEvent("aip_consentinit",{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(l)}catch(g){}},!1],null);__cmp("addEventListener",["settings",function(f,n){try{var l=new CustomEvent("aip_consentsettings",{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(l)}catch(g){}},!1],null);__cmp("addEventListener",["consentscreen",function(f,n){try{var l=new CustomEvent("aip_consentscreen",{detail:{eventname:f,cmpobject:n}});
document.dispatchEvent(l)}catch(g){}},!1],null);__cmp("addEventListener",["consentscreenoff",function(f,n){try{var l=new CustomEvent("aip_consentscreenoff",{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(l)}catch(g){}},!1],null);__cmp("addEventListener",["liestablished",function(f,n){try{var l=new CustomEvent("aip_consentliestablished",{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(l)}catch(g){}},!1],null)}if(!0===aiptag.cmp.show)if("true"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=true, user from EEA, GDPR Consent required"),
b();else if("false"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=false, user not from EEA, GDPR Consent not required"),c();else{var d=new XMLHttpRequest;d.onreadystatechange=function(){if(d.readyState==XMLHttpRequest.DONE)if(200==d.status){var e="";try{e=d.responseText.toUpperCase()}catch(f){}0<="AT AX BE BG CY CZ DE DK EE EL ES EU FI FR GB GF GI GP GR HR HU IE IS IT LI LT LU LV ME MF MQ MT NL NO PL PT RE RO SE SI SK YT UK".split(" ").indexOf(e)?(a("userFromEEA","true","7889229"),
aipAPItag.userFromEEA="true",aipAPItag.log("GDPR Consent required for "+e),b()):(a("userFromEEA","false","7889229"),aipAPItag.userFromEEA="false",aipAPItag.log("GDPR Consent not required for "+e),c())}else aipAPItag.log("Unknown geo-targeting issue, assuming user from EEA"),aipAPItag.userFromEEA="true",b()};d.ontimeout=function(e){aipAPItag.log("Geo-targeting timeout occured, assuming user from EEA");aipAPItag.userFromEEA="true";b()};d.open("GET","https://country.adinplay.workers.dev/",!0);d.timeout=
1500;d.send()}else c()};aipAPI.prototype.showCMPScreen=function(){try{window.__cmp("showGDPRScreen")}catch(a){}};aipAPI.prototype.showCMPButton=function(){try{document.getElementById("cmpPersistentLink").style.display="block"}catch(a){}};aipAPI.prototype.hideCMPButton=function(){try{document.getElementById("cmpPersistentLink").style.display="none"}catch(a){}};aipAPI.prototype.showConsentToolSettings=function(){aipAPItag.showCMPScreen()};aipAPI.prototype.showConsentToolButton=function(){aipAPItag.showCMPButton()};
aipAPI.prototype.hideConsentToolButton=function(){aipAPItag.hideCMPButton()};aipAPI.prototype.initDisplayTag=function(){aiptag.cmd.display.push=function(a){Array.prototype.push.apply(this,arguments);aipAPItag.executeDisplayCmd()};aipAPItag.executeDisplayCmd()};aipAPI.prototype.executeDisplayCmd=function(){for(k=0;k<aiptag.cmd.display.length;k++)aiptag.cmd.display[k]();aiptag.cmd.display.length=0};
aipAPI.prototype.initPlayerTag=function(){aiptag.cmd.player.push=function(a){Array.prototype.push.apply(this,arguments);aipAPItag.executePlayerCmd()};aipAPItag.executePlayerCmd()};aipAPI.prototype.executePlayerCmd=function(){for(k=0;k<aiptag.cmd.player.length;k++)aiptag.cmd.player[k]();aiptag.cmd.player.length=0};aipAPI.prototype.isHidden=function(a){a=document.getElementById(a);var c=!1;try{null===a&&(c=!0),c=null===a.offsetParent}catch(b){}return c};
aipAPI.prototype.validateQueryParams=function(a,c){try{var b="=";c||(b=c="");return-1!==(window.location!=window.parent.location?document.referrer:document.location.href).indexOf(a+b+c)?!0:!1}catch(d){}};aipAPI.prototype.urlParamUpdate=function(a,c,b,d){var e=new RegExp("[\\?&]"+c+"=([^&#]*)","i"),f=e.exec(a);if(null===f)d=/\?/.test(a),a=a+(d?"&":"?")+c+"="+b;else{var n=f[0].charAt(0);a=!0===d?a.replace(e,n+c+"="+f[1]+"%26"+b):a.replace(e,n+c+"="+b)}return a};
aipAPI.prototype.restoreLog=function(){try{if(!("console"in window&&"firebug"in console)){console.log=null;console.log;delete console.log;var a=document.createElement("iframe");a.style.display="none";document.body.appendChild(a);window.console=a.contentWindow.console}}catch(c){}};
aipAPI.prototype.log=function(a,c){if(this.debug){aipAPItag.restoreLog();try{if("string"==typeof a){var b=(new Date).toLocaleTimeString();b+=":"+(new Date).getMilliseconds();window.console.log.apply(console,["%cAdinPlay","display: inline-block; color: #fff; background: #DD0420; padding: 1px 4px; border-radius: 3px;",b,a])}else console.log(a);c&&console.log(c)}catch(d){}}};
aipAPI.prototype.getScript=function(a,c){var b=document.head||document.getElementsByTagName("head")[0],d=document.createElement("script"),e=!0;d.async="async";d.type="text/javascript";d.charset="UTF-8";d.src=a;d.onerror=d.onload=d.onreadystatechange=function(){!e||d.readyState&&!/loaded|complete/.test(d.readyState)||(e=!1,c(),d.onerror=d.onload=d.onreadystatechange=null)};b.appendChild(d)};
aipAPI.prototype.sdkLoaded=function(){return"undefined"!=typeof google&&google&&"undefined"!=typeof google.ima&&google.ima?!0:!1};aipAPI.prototype.isInPage=function(a){try{return a===document.body?!1:document.body.contains(a)}catch(c){return!1}};aipAPI.prototype.isMobile=function(){try{if(/Mobi|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))return!0}catch(a){}return!1};
aipAPI.prototype.wait=function(a,c,b,d,e){var f=0,n=function(){f+=a;b()?d():f>=c?e():setTimeout(n,a)};n()};aipAPI.prototype.inIframe=function(){try{return window.self!==window.top}catch(a){return!0}};aipAPI.prototype.forceRedraw=function(a){if(a){var c=document.createTextNode(" "),b=a.style.display;a.appendChild(c);a.style.display="none";setTimeout(function(){a.style.display=b;c.parentNode.removeChild(c)},20);aipAPItag.log("forceRedraw")}};
aipAPI.prototype.inArray=function(a,c){for(var b=0,d=0,e=c.length;d<e;d++){if(c[d]==a)return d;b++}return-1};aipAPI.prototype.deepEqual=function(a,c){var b=Object.keys(a),d=Object.keys(c);if(b.length!==d.length)return!1;b=$jscomp.makeIterator(b);for(d=b.next();!d.done;d=b.next()){var e=d.value;d=a[e];e=c[e];var f=aipAPItag.isObject(d)&&aipAPItag.isObject(e);if(f&&!aipAPItag.deepEqual(d,e)||!f&&d!==e)return!1}return!0};aipAPI.prototype.isObject=function(a){return null!=a&&"object"===typeof a};
aipAPI.prototype.addBidder=function(a,c){var b=!1;aipAPItag.adUnits[a][0].bids.forEach(function(d){aipAPItag.deepEqual(c,d)&&(b=!0)});b||aipAPItag.adUnits[a][0].bids.push(c)};aipAPI.prototype.sendEvent=function(a){this.log(a);aipSendEvent(a)};var aipSendEvent=function(a){};aipAPI.prototype.setCurrency=function(){aip_pbjs.que.push(function(){aip_pbjs.setConfig({currency:{adServerCurrency:"EUR",granularityMultiplier:1,bidderCurrencyDefault:{openx:"EUR"}}})})};
aipAPI.prototype.getAllBids=function(){(function(){function a(e,f){Object.keys(e).forEach(function(n){e[n].bids.forEach(function(l){f(n,l)})})}var c=aip_pbjs.getAllWinningBids(),b=[];a(aip_pbjs.getBidResponses(),function(e,f){b.push({bid:f,adunit:e,adId:f.adId,bidder:f.bidder,time:f.timeToRespond,cpm:f.cpm,msg:f.statusMessage,rendered:!!c.find(function(n){return n.adId==f.adId})})});a(aip_pbjs.getNoBids&&aip_pbjs.getNoBids()||{},function(e,f){b.push({msg:"no bid",adunit:e,adId:f.bidId,bidder:f.bidder})});
if(b.length)if(console.table)console.table(b);else for(var d=0;d<b.length;d++)console.log(b[d]);else console.warn("NO prebid responses")})()};
aipAPI.prototype.getAllWinningBids=function(){(function(){var a=aip_pbjs.getBidResponses(),c=aip_pbjs.getAllWinningBids(),b=[];Object.keys(a).forEach(function(e){a[e].bids.forEach(function(f){b.push({bid:f,adunit:e,adId:f.adId,bidder:f.bidder,time:f.timeToRespond,cpm:f.cpm,msg:f.statusMessage,rendered:!!c.find(function(n){return n.adId==f.adId})})})});if(b.length)if(console.table)console.table(b);else for(var d=0;d<b.length;d++)console.log(b[d]);else console.warn("NO prebid responses")})()};
aipAPI.prototype.getHighestCpmBids=function(){for(var a=aip_pbjs.getHighestCpmBids(),c=[],b=0;b<a.length;b++){var d=a[b];c.push({adunit:d.adUnitCode,adId:d.adId,bidder:d.bidder,time:d.timeToRespond,cpm:d.cpm})}if(c.length)if(console.table)console.table(c);else for(a=0;a<c.length;a++)console.log(c[a]);else console.warn("No prebid winners")};
aipAPI.prototype.start=function(){!0!==aipAPItag.started&&(aipAPItag.started=!0,aiptag.settings.iDFPAdSlots&&(aipDisplayTag=new aipDisplay,aipDisplayTag.displayInit(),aipAPItag.initDisplayTag(),googletag.cmd.push(function(){googletag.pubads().addEventListener("slotRenderEnded",function(a){try{var c=new CustomEvent("aip_slotRenderEnded",{detail:{slotElementId:a.slot.getSlotElementId(),isEmpty:a.isEmpty}});document.dispatchEvent(c)}catch(b){}})})),aiptag.settings.sAdUnitVideo||aiptag.settings.sRewardedAdUnitVideo)&&
(aiptag.settings.sRewardedAdUnitVideo&&!aiptag.settings.sAdUnitVideo?aipAPItag.initPlayerTag():aipAPItag.sdkLoaded()?aipAPItag.initPlayerTag():aipAPItag.getScript("//imasdk.googleapis.com/js/sdkloader/ima3.js",function(){aipAPItag.initPlayerTag();aipAPItag.sdkLoaded()||(aipAPItag.sdkBlocked=!0)}))};
function aipDisplay(){aiptag.settings.iAutoRefreshBanners&&aiptag.settings.iAutoRefreshBannersViewPercentage&&aiptag.settings.iAutoRefreshBannersTimeout&&googletag.cmd.push(function(){googletag.pubads().addEventListener("slotVisibilityChanged",function(a){var c=a.slot.getSlotElementId();aipAPItag.adUnitsPercentage[c]=a.inViewPercentage;1==aipAPItag.adUnitsRefreshFlag[c]&&(aipAPItag.adUnitsRefreshFlag[c]=!1,aipDisplayTag.display(c))})})}
...
aipDisplay.prototype.displaySetup=function(a){aip_pbjs.que.push(function(){aipAPItag.displayBidCpm.rhythmone=.9;aipAPItag.displayBidCpm.rubicon=.62;aipAPItag.displayBidCpm.GumGum=.95;if(aiptag.settings.sCustomDisplayBidCpmAdjustment){var c=aiptag.settings.sCustomDisplayBidCpmAdjustment;for(key in c)c[key][a]&&(aipAPItag.log("Custom Bid adjust "+key+" for: "+a+" with value: "+c[key][a]),aipAPItag.displayBidCpm[key]=c[key][a])}aip_pbjs.bidderSettings={rhythmone:{bidCpmAdjustment:function(b,d){aipAPItag.log("Bid adjust for: "+
d.bidderCode);return b*aipAPItag.displayBidCpm.rhythmone}},rubicon:{bidCpmAdjustment:function(b,d){aipAPItag.log("Bid adjust for: "+d.bidderCode);return b*aipAPItag.displayBidCpm.rubicon}}};aipAPItag.debug&&aip_pbjs.setConfig({debug:!0});aip_pbjs.setConfig({userSync:{iframeEnabled:!0,useBidCache:!0,syncsPerBidder:1E3,filterSettings:{all:{bidders:"*",filter:"include"}},syncDelay:100},bidderTimeout:aipAPItag.timeout_bid_display,enableSendAllBids:!0,bidderSequence:"random",priceGranularity:{buckets:[{precision:2,
...
aipDisplay.prototype.refreshTag=function(a){aipAPItag.queue_ready_display=!0;if(aipDisplayTag.getReload(a))if(aipAPItag.adUnitsRefreshed[a]||(aipAPItag.adUnitsRefreshed[a]=0),aipAPItag.adUnitsRefreshed[a]++,aiptag.settings.iDisableEvenAddRefresh&&0==aipAPItag.adUnitsRefreshed[a]%2)aipAPItag.log("AD REFRESH EVEN for: "+a);else{aipAPItag.cutomSizeConfig();googletag.cmd.push(function(){googletag.pubads().setTagForChildDirectedTreatment(0)});aiptag.settings.iChildSafeAds&&googletag.cmd.push(function(){googletag.pubads().setTagForChildDirectedTreatment(1);
aipAPItag.log("COPPA: "+a+" ad request marked with a child-directed status")});if(aipAPItag.inIframe()){aipAPItag.log("iframe display AD, GS=Yes");googletag.cmd.push(function(){googletag.pubads().setTargeting("GS","Yes")});try{aipAPItag.adUnits[a][0].bids.forEach(function(b,d,e){"gumgum"===b.bidder&&e.splice(d,1)})}catch(b){}}else aipAPItag.log("none iframe display Ad, GS=No"),googletag.cmd.push(function(){googletag.pubads().setTargeting("GS","No")});aiptag.subid&&(aipAPItag.log("Custom SubID"),googletag.cmd.push(function(){googletag.pubads().setTargeting("subid",
aiptag.subid)}));googletag.cmd.push(function(){try{var b=aipAPItag.adUnitsRefreshed[a].toString();googletag.pubads().setTargeting("FC",b);aipAPItag.log(a+", FC="+b)}catch(d){}});var c="Other";try{/(cros)/.test(window.navigator.userAgent.toLowerCase())&&(c="ChromeOS")}catch(b){}googletag.cmd.push(function(){googletag.pubads().setTargeting("OS",c);aipAPItag.log("OS="+c)});aipAPItag.log("AD SLOT REFRESHTAG: "+a+" - "+aipAPItag.adUnitsRefreshed[a]);aipAPItag.queue_ready_display=!1;aip_pbjs.que.push(function(){aipAPItag.adUnitsLoaded[a]||
(aipAPItag.adUnitsLoaded[a]="loaded",googletag.cmd.push(function(){aipAPItag.adSlot[a]=googletag.defineSlot("/"+aiptag.settings.sNetworkIdDisplay+"/"+aipAPItag.adSlots[a].adunit,aipAPItag.adSlots[a].sizes,a).addService(googletag.pubads());googletag.enableServices();googletag.display(a);aipAPItag.log("AD SLOT DEFINED: "+a)}));aipDisplayTag.unsetReload(a);setTimeout(aipDisplayTag.setReload.bind(null,a),aipAPItag.timeout_reload_display);aipDisplayTag.displaySetup(a);var b=aipAPItag.timeout_bid_display;
aipAPItag.log("AD REQUEST: "+a);aipAPItag.requestManager[a].adserverRequestSent=!1;aipAPItag.requestManager[a].prebid=!1;aipAPItag.requestManager[a].aps=!1;window.setTimeout(function(){aipDisplayTag.sendAdserverRequest(a)},b);aip_pbjs.requestBids({timeout:b,adUnits:aipAPItag.adUnits[a],adUnitCodes:[a],bidsBackHandler:function(d){try{aipAPItag.log("Targeting params:"),aipAPItag.log(JSON.stringify(aip_pbjs.getAdserverTargeting())),aipAPItag.log("All bid objects:"),aipAPItag.log(JSON.stringify(aip_pbjs.getBidResponses()))}catch(e){}googletag.cmd.push(function(){aiptag.settings.iShowAdblockAdsDisplay&&
aipAPItag.gptBlocked?(aipDisplayTag.blocked(a),aipAPItag.queue_ready_display=!0,aipDisplayTag.nextQueue()):(aip_pbjs.setTargetingForGPTAsync([a]),aipAPItag.requestManager[a].prebid=!0,aipDisplayTag.biddersBack(a),aipAPItag.log("prebid biddersBack - "+a))})}});aiptag.settings.iAmazonAds&&apstag.fetchBids({slots:aipAPItag.adUnitsAps[a],timeout:b},function(d){googletag.cmd.push(function(){apstag.setDisplayBids();aipAPItag.requestManager[a].aps=!0;aipAPItag.log("aps biddersBack - "+a);aipDisplayTag.biddersBack(a)})})})}else aipAPItag.log("AD REFRESH called to soon for: "+
...
aipDisplay.prototype.blocked=function(a){if(aiptag.settings.iShowAdblockAdsDisplay)try{var c=[],b="";c["300x250"]=[["300250.jpg",""],["300250.jpg",""]];aipAPItag.adSlot[a].getSizes().forEach(function(d){fallbackSize=d.getWidth()+"x"+d.getHeight();c[fallbackSize]&&(index=Math.floor(Math.random()*c[fallbackSize].length),source=aipAPItag.adSlot[a].getAdUnitPath().replace("/"+aiptag.settings.sNetworkIdDisplay+"/",""),b="<a style='display: inline-block;' target='_blank' href='"+c[fallbackSize][index][1]+
source+"'><div style='width:"+d.getWidth()+"px;height:"+d.getHeight()+'px; background-image: url("//api.adinplay.com/libs/aiptag/fallback/'+c[fallbackSize][index][0]+"\")'></div></a>")});b&&(document.getElementById(a).innerHTML=b,aipAPItag.log("AD BLOCKED: "+a))}catch(d){}};aipDisplay.prototype.wrapFunction=function(a,c,b){return function(){a.apply(c,b)}};aipDisplay.prototype.nextQueue=function(){1==aipAPItag.queue_ready_display&&0<aiptag.cmd.queue.length&&(aipAPItag.log("AD SLOT NEXT QUEUE"),aiptag.cmd.queue.shift()())};
function aipPlayer(a){this.aipConfig={VERSION:aiptag.settings.sVersion,AD_WIDTH:960,AD_HEIGHT:540,LOADING_TEXT:"loading advertisement",PREROLL_ELEM:function(){return document.getElementById("preroll")},PREROLL_ELEM_ID:!1,PREROLL_CONTAINER:!1,AD_FULLSCREEN:!1,AD_CENTERPLAYER:!1,AD_FADING:aiptag.settings.iAdFading,DESCRIPTION_URL:aipAPItag.protocol+aiptag.settings.sPubUrl+"/"};a&&this.configure(a);try{var c=document.createElement("style");this.aipConfig.PREROLL_ELEM_ID="function"===typeof this.aipConfig.PREROLL_ELEM?
this.aipConfig.PREROLL_ELEM().id:this.aipConfig.PREROLL_ELEM.id;c.type="text/css";c.innerHTML="#"+this.aipConfig.PREROLL_ELEM_ID+" video {left: 0;top: 0;}";document.getElementsByTagName("head")[0].appendChild(c)}catch(b){}}aipPlayer.prototype.configure=function(a){var c;for(c in a){var b=a[c];void 0!==b&&a.hasOwnProperty(c)&&(this.aipConfig[c]=b)}return this};
aipPlayer.prototype.getBidPrerollTag=function(a){aip_pbjs.que.push(function(){aipAPItag.debug&&aip_pbjs.setConfig({debug:!0});aip_pbjs.setConfig({userSync:{iframeEnabled:!0,useBidCache:!0,syncsPerBidder:1E3,filterSettings:{all:{bidders:"*",filter:"include"}},syncDelay:100},cache:{url:"https://prebid.adnxs.com/pbc/v1/cache"},bidderTimeout:aipAPItag.timeout_bid_player,enableSendAllBids:!1,bidderSequence:"random",priceGranularity:{buckets:[{precision:2,min:0,max:.1,increment:.01},{precision:2,min:.1,
...
aipPlayer.prototype.preparePreRoll=function(){var a={};aipAPItag.inIframe()?(a.GS="Yes",aipAPItag.log("iframe preroll AD")):a.GS="No";aiptag.subid&&(a.subid=aiptag.subid,aipAPItag.log("Custom SubID"));a.FC=aiptag.prerollCount;a.tfcd="0";aiptag.settings.iChildSafeAds&&(a.tfcd="1",aipAPItag.log("COPPA: video ad request marked with a child-directed status"));var c=Object.keys(a).map(function(b){return b+"%3D"+a[b]}).join("%26");if(c)try{this.aipConfig.AD_TAG=aipAPItag.urlParamUpdate(this.aipConfig.AD_TAG,
"cust_params",c,!0)}catch(b){}this.prepareAd()};
aipPlayer.prototype.startRewardedAd=function(){var a=this;this.showLoading(!0,!0);aipAPItag.aipRewardCompleteExec="";googletag.cmd.push(function(){aipAPItag.aipAPIrewardedSlot||(googletag.pubads().addEventListener("rewardedSlotReady",function(b){b.makeRewardedVisible();aipAPItag.log("Rewarded AD: Slot Ready");clearTimeout(aipAPItag.completedTimeoutRewarded);this.showLoading(!1)}.bind(a)),googletag.pubads().addEventListener("rewardedSlotGranted",function(b){aipAPItag.log("Rewarded AD: Granted");this.aipRewardComplete("granted",
!1)}.bind(a)),googletag.pubads().addEventListener("rewardedSlotCanceled",function(b){aipAPItag.log("Rewarded AD: Canceled");this.aipRewardComplete("canceled",!1)}.bind(a)),googletag.pubads().addEventListener("slotRenderEnded",function(b){b.slot.getSlotId().getName()==aipAPItag.aipAPIrewardedSlotId&&aipAPItag.log("Rewarded AD: slotRenderEnded");b.slot.getSlotId().getName()==aipAPItag.aipAPIrewardedSlotId&&b.isEmpty&&(aipAPItag.log("Rewarded AD: Empty"),this.aipRewardComplete("empty",!0))}.bind(a)),
googletag.pubads().addEventListener("rewardedSlotFailedToLoad",function(b){aipAPItag.log("Rewarded AD: Failed to load!");this.aipRewardComplete("failed",!0)}.bind(a)),googletag.pubads().addEventListener("rewardedSlotClosed",function(b){aipAPItag.log("Rewarded AD: Closed");this.aipRewardComplete("closed",!1)}.bind(a)),googletag.pubads().addEventListener("rewardedSlotCompleted",function(b){aipAPItag.log("Rewarded AD: Completed!");this.aipRewardComplete("completed",!1)}.bind(a)),googletag.enableServices());
aipAPItag.inIframe()?(aipAPItag.log("iframe rewarded AD, GS=Yes"),googletag.pubads().setTargeting("GS","Yes")):(aipAPItag.log("none iframe rewarded Ad, GS=No"),googletag.pubads().setTargeting("GS","No"));aipAPItag.adUnitsRefreshed.rewarded||(aipAPItag.adUnitsRefreshed.rewarded=0);aipAPItag.adUnitsRefreshed.rewarded++;var c=aipAPItag.adUnitsRefreshed.rewarded.toString();googletag.pubads().setTargeting("FC",c);aipAPItag.log("Rewarded, FC="+c);aipAPItag.aipAPIrewardedSlot=googletag.defineOutOfPageSlot(aipAPItag.aipAPIrewardedSlotId,
googletag.enums.OutOfPageFormat.REWARDED).addService(googletag.pubads());googletag.pubads().refresh([aipAPItag.aipAPIrewardedSlot]);aipAPItag.log("Rewarded AD: Start")})};
aipPlayer.prototype.startPreRoll=function(a){if(aiptag.settings.iForceRewardedAd&&aipAPItag.isMobile()&&!a)this.startRewardedAd(),aipAPItag.log("startRewardedAd");else{this.aipConfig.AD_UNIT_PREROLL=aiptag.settings.sAdUnitVideo;a&&(this.aipConfig.AD_UNIT_PREROLL=a);a=(new Date).getTime();var c=encodeURIComponent(window.location.href).replace(/'/g,"%27").replace(/"/g,"%22"),b=encodeURIComponent(this.aipConfig.DESCRIPTION_URL).replace(/'/g,"%27").replace(/"/g,"%22");this.aipConfig.AD_TAG="https://pubads.g.doubleclick.net/gampad/ads?sz=960x540&iu=/"+
aiptag.settings.sNetworkIdVideo+"/"+this.aipConfig.AD_UNIT_PREROLL+"&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&max_ad_duration=30000&url="+c+"&description_url="+b+"&correlator="+a;aipAPItag.log(this.aipConfig.AD_TAG);aiptag.prerollCount=aiptag.prerollCount+1||1;aiptag.settings.iVideoAdUnitBidders?aipAPItag.inIframe()?(aipAPItag.log("iframe AD - Normal Ad"),this.preparePreRoll()):(aipAPItag.log("none iframe - Bid Ad"),this.getBidPrerollTag(this)):(aipAPItag.log("No Bid placementID - Normal Ad"),
this.preparePreRoll())}};
...
"fixed",this.aipConfig.PREROLL_CONTAINER.style.zIndex="999996",this.aipConfig.PREROLL_CONTAINER.style.overflow="hidden",this.aipConfig.PREROLL_CONTAINER.className="";else{var a=document.getElementById("aipPrerollContainer");if("undefined"==typeof a||null==a)a=document.createElement("div"),a.id="aipPrerollContainer",this.aipConfig.PREROLL_ELEM.appendChild(a);this.aipConfig.PREROLL_CONTAINER=document.getElementById("aipPrerollContainer");try{var c=window.getComputedStyle(this.aipConfig.PREROLL_ELEM,
null).getPropertyValue("position");if(""==c||"static"==c)this.aipConfig.PREROLL_ELEM.style.position="relative"}catch(d){}try{var b=window.getComputedStyle(this.aipConfig.PREROLL_ELEM,null).getPropertyValue("z-index");if(""==b||isNaN(b))this.aipConfig.PREROLL_ELEM.style.zIndex="999996"}catch(d){}this.aipConfig.PREROLL_CONTAINER.style.width=this.aipConfig.AD_WIDTH+"px";this.aipConfig.PREROLL_CONTAINER.style.height=this.aipConfig.AD_HEIGHT+"px";this.aipConfig.PREROLL_ELEM.style.width=this.aipConfig.AD_WIDTH+
...
aipPlayer.prototype.aipRewardComplete=function(a,c){""!=aipAPItag.aipRewardCompleteExec?aipAPItag.log("Rewarded AD: aipRewardComplete called twice"):(aipAPItag.aipRewardCompleteExec=Date.now(),clearTimeout(aipAPItag.completedTimeoutRewarded),aiptag.settings.iForceRewardedAd?c?aiptag.settings.sRewardAdUnitVideoFallback?this.startPreRoll(aiptag.settings.sRewardAdUnitVideoFallback):(this.showLoading(!1),this.aipConfig.AIP_COMPLETE&&this.aipConfig.AIP_COMPLETE(a)):(this.showLoading(!1),this.aipConfig.AIP_COMPLETE&&
this.aipConfig.AIP_COMPLETE(a)):(this.showLoading(!1),this.aipConfig.AIP_REWARDEDCOMPLETE&&this.aipConfig.AIP_REWARDEDCOMPLETE(a)))};
aipPlayer.prototype.aipComplete=function(a){try{this.aipConfig.PREROLL_ELEM.style.display="none"}catch(c){}this.showLoading(!1);this.aipConfig.AIP_COMPLETE&&setTimeout(function(){aipAPItag.prerollSkipped&&(a="video-ad-skipped");this.aipConfig.AIP_COMPLETE(a)}.bind(this),300);this.aipConfig.AIP_REMOVE&&setTimeout(function(){aipAPItag.isInPage(this.aipConfig.PREROLL_CONTAINER)||1!=aipAPItag.sdkBlocked&&console.log("***WARNING*** PREROLL_CONTAINER is removed prematurely, please do not remove PREROLL_CONTAINER on AIP_COMPLETE, you can remove it on AIP_REMOVE");
this.aipConfig.AIP_REMOVE()}.bind(this),3E3);try{document.getElementById(aipThis.aipConfig.PREROLL_ELEM_ID).removeEventListener("click",handlePaused)}catch(c){}};
aipPlayer.prototype.showLoading=function(a,c){if(this.aipConfig.AD_FULLSCREEN||c)if(a){var b=document.getElementById("divFullscreenLoading");if("undefined"==typeof b||null==b)b=document.createElement("div"),b.id="divFullscreenLoading",b.style.overflow="hidden",b.style.position="fixed",b.style.zIndex="999997",b.style.margin="auto",b.style.top="0",b.style.left="0",b.style.bottom="0",b.style.right="0",b.style.width="100%",b.style.height="100%",b.style.backgroundColor="#000000",b.innerHTML='<img border="0" style="position: fixed;z-index: 999998;top: 50%;left: 50%;transform: translate(-50%, -50%);" src="//api.adinplay.com/libs/aiptag/assets/loader-red.gif" />',
document.getElementsByTagName("body")[0].appendChild(b)}else{b=document.getElementById("divFullscreenLoading");"undefined"!=typeof b&&null!=b&&(b=document.getElementById("divFullscreenLoading"),b.parentNode.removeChild(b));try{document.getElementById("aipLoadingTxt").style.display="none"}catch(d){}}else if(a)b=document.createElement("div"),b.id="divFullscreenLoading",b.style.overflow="hidden",b.style.position="absolute",b.style.top="0",b.style.left="0",b.style.bottom="0",b.style.right="0",b.style.zIndex=
"999997",b.style.width=this.aipConfig.AD_WIDTH+"px",b.style.height=this.aipConfig.AD_HEIGHT+"px",b.style.backgroundColor="#000000",b.innerHTML='<img border="0" style="position: absolute;z-index: 999998;top: 50%;left: 50%;transform: translate(-50%, -50%);" src="//api.adinplay.com/libs/aiptag/assets/loader-red.gif" />',this.aipConfig.PREROLL_ELEM.appendChild(b);else{b=document.getElementById("divFullscreenLoading");"undefined"!=typeof b&&null!=b&&(b=document.getElementById("divFullscreenLoading"),b.parentNode.removeChild(b));
...
this.aipConfig.LOADING_TEXT+'<img style="margin-left: 10px;vertical-align: middle;" src="data:image/gif;base64,"/></span></div><button id="aipVideoAdUiSkipButton" style="display: none;border:0;background: rgba(0,0,0,0.8);color: #fff;cursor: pointer;font-size: 14px;"><div style="display: inline-block;font-size: 14px;vertical-align: middle;width: initial;">Skip Ad</div><div style="background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAQAAABKfvVzAAAABGdBTUEAALGPC/xhBQAAAAJiS0dEAP+Hj8y/AAAAZElEQVQ4y+3SwQmDQBBGYRFy9mYLSRXWEyvRRtKBbdhDUoTH8HkVllX+u++48GD2zTTNTYiPrnhDXeBnyAT+Zo9EgNUrE9iMmQCLvhTas2jXWY8jvbNPP5OsU5L1my0uPY2bCjtXdo6mqRVtTgAAAABJRU5ErkJggg==);background-repeat: no-repeat;display: inline-block;height: 24px;width: 24px;margin-left: 2px;vertical-align: middle;"></div></button><span style="font-size: 16px;font-family: \'open sans\';font-weight: 100;color: #fff;padding-left: 5px;" id="loading-text-aip"></span><a style="margin-top: 6px;position: absolute;right: 5px;" target="_blank" href="https://adinplay.com/?utm_source=publishers&utm_medium=websites&utm_campaign=PrerollVideo"><img style="vertical-align: top;position: relative;" id="aipLogo" src="data:image/png;base64," border="0" /></a></div></div>'};
aipPlayer.prototype.activeViewDetect=function(){var a=document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,c=document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight,b=this.aipConfig.AD_WIDTH,d=this.aipConfig.AD_HEIGHT;aiptag.settings.iHideBranding||(d+=26);if(a<b||c<d)this.aipConfig.AD_FULLSCREEN=!0};
aipPlayer.prototype.requestAd=function(a,c,b,d){null==aipAPItag.aipAds&&(b("LOADED FIRST TIME"),aipAPItag.aipAds=new AipAds(a,a.aipConfig.PREROLL_CONTAINER,a.aipConfig.PREROLL_CONTAINER,d));try{aipAPItag.aipAds.requestAds(c,b),a.aipConfig.PREROLL_ELEM.style.display="block"}catch(e){b("EXCEPTION",{name:e.name,message:e.message,stack:e.stack}),a.aipComplete("ad-exception")}};
function AipAds(a,c,b,d){function e(){aipAPItag.sendEvent("video-ad-paused");try{document.getElementById(a.aipConfig.PREROLL_ELEM_ID).addEventListener("click",f)}catch(h){}}function f(){aipAPItag.sendEvent("video-ad-resumed-forced");p.resume()}function n(){aipAPItag.sendEvent("video-ad-resumed");try{document.getElementById(a.aipConfig.PREROLL_ELEM_ID).removeEventListener("click",f)}catch(h){}}function l(h){y("EXCEPTION",{name:h.name,message:h.message,stack:h.stack})}function g(h){var u="",r="",z=
"";try{u=h.getAd().getContentType(),r=h.getAd().getMinSuggestedDuration(),z=h.getAd().getCreativeId()}catch(E){l(E)}y("CONTENT_PAUSE_REQUESTED",{contentType:u,creativeId:z,minSuggestedDuration:r})}function m(h){x();b.style.display="block";a.showLoading(!1);a.aipConfig.AIP_STARTED&&a.aipConfig.AIP_STARTED();try{aipAPItag.forceRedraw(document.getElementById(a.aipConfig.PREROLL_ELEM_ID))}catch(u){}if(d)try{y("MediaUrl: "+h.getAd().getMediaUrl()+"; AdvertiserName: "+h.getAd().getAdvertiserName()+"; Description: "+
h.getAd().getDescription()+"; Title: "+h.getAd().getTitle())}catch(u){l(u)}y("STARTED");aipAPItag.sendEvent("video-ad-started");aiptag.settings.iSkipButtonTimeout&&(aipAPItag.showSkipButtonTimer=setTimeout(function(){a.showSkipButton();try{document.getElementById("aipVideoAdUiSkipButton").onclick=function(){B.contentComplete();p.destroy();y("CONTENT_RESUME_REQUESTED");C=!1;w("video-ad-completed");aipAPItag.sendEvent("video-ad-removed")}}catch(u){}},aiptag.settings.iSkipButtonTimeout))}function q(){B.contentComplete();
p&&p.destroy();y("CONTENT_RESUME_REQUESTED");C=!1;w("video-ad-completed");aipAPItag.sendEvent("video-ad-removed")}function t(h){x();y(h.getError());B.contentComplete();p&&p.destroy();var u=(new Date).getTime()-H;1012==h.getError().getErrorCode()&&0<=u&&800>u?(y("AD BLOCKED",{timeElapsed:u}),a.aipConfig.AIP_BLOCKED&&a.aipConfig.AIP_BLOCKED(),aipAPItag.sendEvent("user-has-adblock"),h="user-has-adblock"):h.getError().getErrorCode()==google.ima.AdError.ErrorCode.VAST_EMPTY_RESPONSE||901==h.getError().getErrorCode()&&
h.getError().getInnerError()&&"Error: No ads available"==h.getError().getInnerError().message?(y("NO ADS",{errorCode:h.getError().getErrorCode(),message:h.getError().getMessage(),innerError:h.getError().getInnerError(),vastErrorCode:h.getError().getVastErrorCode(),timeElapsed:u}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-empty"),h="video-ad-empty"):(y("ERROR",{errorCode:h.getError().getErrorCode(),message:h.getError().getMessage(),innerError:h.getError().getInnerError(),
vastErrorCode:h.getError().getVastErrorCode(),timeElapsed:u}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-error"),h="video-ad-error");C=!1;w(h)}function v(){G=!0;C=!1;B.contentComplete();p&&p.destroy();y("TIMEOUT");w("video-ad-timeout");aipAPItag.sendEvent("video-ad-timeout")}function x(){F&&(clearTimeout(F),F=null)}function w(h){try{clearTimeout(aipAPItag.completedTimeoutPreroll)}catch(z){}if(aiptag.settings.iSkipButtonTimeout)try{clearTimeout(aipAPItag.showSkipButtonTimer)}catch(z){}try{var u=
document.getElementById("aipBranding");if("undefined"!=typeof u&&null!=u){var r=document.getElementById("aipBranding");r.parentNode.removeChild(r)}}catch(z){}x();a.aipComplete(h)}function D(){a.aipConfig.AD_FULLSCREEN?(windowWidth=document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,windowHeight=document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight,aiptag.settings.iHideBranding||(windowHeight-=26)):(windowWidth=c.offsetWidth,windowHeight=
c.offsetHeight);return{adWidth:windowWidth,adHeight:windowHeight}}var B,p,C,H,F,G,y=function(){};window.addEventListener("error",function(h){if(C)try{y("WINDOW_EXCEPTION",{name:"WindowErrorListener: "+h.error.toString(),message:h.error.toString(),stack:h.error.stack})}catch(u){}});(function(){var h=new google.ima.AdDisplayContainer(b);h.initialize();B=new google.ima.AdsLoader(h);B.getSettings().setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.INSECURE);B.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,
function(u){function r(A){return function(){"COMPLETE"==A&&(aipAPItag.sendEvent("video-ad-completed"),aipAPItag.completedTimeoutPreroll=setTimeout(q,1500));"CLICK"==A&&aipAPItag.sendEvent("video-ad-clicked");"USER_CLOSE"==A&&aipAPItag.sendEvent("video-ad-close");"LOADED"==A&&(aipAPItag.sendEvent("video-ad-loaded"),aipAPItag.prerollSkipped=!1);"SKIPPED"==A&&(aipAPItag.sendEvent("video-ad-skipped"),aipAPItag.prerollSkipped=!0);if("SKIPPABLE_STATE_CHANGED"==A&&aiptag.settings.iSkipButtonTimeout)try{clearTimeout(aipAPItag.showSkipButtonTimer),
document.getElementById("aipVideoAdUiSkipButton").style.display="none"}catch(I){}y(A);aipAPItag.log("Preroll status: "+A)}}if(!G){var z=new google.ima.AdsRenderingSettings;z.loadVideoTimeout=12E3;p=u.getAdsManager(c,z);p.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,t);p.addEventListener(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED,g);p.addEventListener(google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED,q);p.addEventListener(google.ima.AdEvent.Type.STARTED,m);p.addEventListener(google.ima.AdEvent.Type.SKIPPED,
r("SKIPPED"));p.addEventListener(google.ima.AdEvent.Type.CLICK,r("CLICK"));p.addEventListener(google.ima.AdEvent.Type.PAUSED,e);p.addEventListener(google.ima.AdEvent.Type.RESUMED,n);p.addEventListener(google.ima.AdEvent.Type.FIRST_QUARTILE,r("FIRST_QUARTILE"));p.addEventListener(google.ima.AdEvent.Type.MIDPOINT,r("MIDPOINT"));p.addEventListener(google.ima.AdEvent.Type.THIRD_QUARTILE,r("THIRD_QUARTILE"));p.addEventListener(google.ima.AdEvent.Type.LOADED,r("LOADED"));p.addEventListener(google.ima.AdEvent.Type.COMPLETE,
r("COMPLETE"));p.addEventListener(google.ima.AdEvent.Type.USER_CLOSE,r("USER_CLOSE"));p.addEventListener(google.ima.AdEvent.Type.SKIPPABLE_STATE_CHANGED,r("SKIPPABLE_STATE_CHANGED"));try{var E=D();a.aipConfig.AD_FULLSCREEN?p.init(E.adWidth,E.adHeight,google.ima.ViewMode.FULLSCREEN):p.init(E.adWidth,E.adHeight,google.ima.ViewMode.NORMAL);p.start()}catch(A){l(A)}}});B.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,t)})();window.addEventListener("resize",function(){if(p&&C&&a.aipConfig.AD_FULLSCREEN){var h=
document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,u=document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight;aiptag.settings.iHideBranding||(u-=26);p.resize(h,u,google.ima.ViewMode.FULLSCREEN)}});this.requestAds=function(h,u){y=u;H=(new Date).getTime();var r=new google.ima.AdsRequest;r.adTagUrl=h;var z=D();r.linearAdSlotWidth=z.adWidth;r.linearAdSlotHeight=z.adHeight;r.nonLinearAdSlotWidth=z.adWidth;r.nonLinearAdSlotHeight=z.adHeight;r.forceNonLinearFullSlot=
!0;r.setAdWillAutoPlay(!1);r.setAdWillPlayMuted(!1);B.requestAds(r);F=setTimeout(v,15E3);G=!1;C=!0}}aipAPItag=new aipAPI;aipAPItag.cutomSizeConfig();aipAPItag.initGPT();aipAPItag.setCurrency();aipAPItag.detectBlockedAds();aipAPItag.initGDPR();